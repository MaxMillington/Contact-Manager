...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  describe "DELETE #destroy" do
    let(:person) { Person.create(first_name: "Jessie", last_name: "Jones") }
    let(:valid_attributes) { { number: "555-888", contact_id: person.id, contact_type: "Person" } }
    let(:new_attributes) { { number: "MyNewString", contact_id: person.id, contact_type: "Person" } }
